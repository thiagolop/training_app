...
class ColorsApp {
  ...
  static Color gradientFrist = const Color(0xff0f17ad);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF1D3B97);
  static Color secondPageContainerGradient2ndColor = const Color(0xFF3E5DB9);
